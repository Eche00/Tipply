...
function Hero() {
  return (
    <div>
       <section className="flex flex-col items-center justify-center text-center gap-[24px] py-[50px] relative z-20" >
        ...
        <Link to='/connect-wallet'  className="w-[146px] h-[40px] bg-gradient-to-b from-[#505050] to-[#030404]  border-b-[1px] border-[#FFFFFFBD] flex  items-center justify-center rounded-[13px]">Connect Wallet</Link>

        <div className="relative w-[400px] mx-auto flex   top-1/2 gap-[20px]">
          <img src="/hey.png" alt="" className=" w-[238px] h-[484px] bg-black object-cover  rounded-[34px]" />
          <img src="/hey.png" alt="" className="absolute top-[50px] right-[0px] w-[238px] h-[484px] bg-black object-cover  rounded-[34px]" />
        </div>
      </section>
    </div>
  )
